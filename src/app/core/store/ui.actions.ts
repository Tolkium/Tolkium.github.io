...
export const toggleScrollbarHidden = createAction('[UI] Toggle Scrollbar Hidden');
export const setScrollbarHidden = createAction(
  '[UI] Set Scrollbar Hidden',
  props<{ isScrollbarHidden: boolean }>()
);